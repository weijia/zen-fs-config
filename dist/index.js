...
__export(index_exports, {
  ...
  createDataSyncGroup: () => createDataSyncGroup,
  ...
  listBackendMetadata: () => listBackendMetadata,
  listBackends: () => listBackends,
  mergeAccountFields: () => mergeAccountFields,
...
var DataSyncGroup = class {
  ...
  constructor(appId, groupId, localFS) {
    this.appId = appId;
    this.groupId = groupId;
    this.syncEngine = new import_zen_fs_sync2.ZenFSSync();
  ...
  async addBackend(id, type, options, description) {
    ...
    const pair = this.syncEngine.addPair(
      ...
      syncable,
      {
        direction: import_zen_fs_sync2.SyncDirection.BiDirectional,
        conflictStrategy: "source-wins"
      },
      "/"
    );
